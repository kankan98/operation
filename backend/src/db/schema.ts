...
export const opportunityResearchEntries = sqliteTable('opportunity_research_entries', {
  ...
  decisionSnapshotJson: text('decision_snapshot_json'),
  decidedAt: integer('decided_at'),
  decisionUpdatedAt: integer('decision_updated_at'),
  lastActionId: text('last_action_id'),
  lastActionOutcome: text('last_action_outcome'),
  lastActionCompletedAt: integer('last_action_completed_at'),
  lastActionUpdatedAt: integer('last_action_updated_at'),
  createdAt: integer('created_at').notNull(),
  updatedAt: integer('updated_at').notNull(),
});
