...
Backend service integrating Anthropic Claude API to power an AI chat assistant for e-commerce operations. Provides streaming responses, conversation persistence, and tool execution capabilities.
