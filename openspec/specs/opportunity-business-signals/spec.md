# Capability: Opportunity Business Signals

## Purpose

This capability enables merchants to persist business assumptions (costs, fees, margins) for products and compute derived financial metrics (gross margin, net margin, ROI, breakeven) to support opportunity scoring and decision-making.
