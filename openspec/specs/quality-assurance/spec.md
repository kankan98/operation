...
This capability defines the standards that protect code quality across the project — test coverage thresholds, test pyramid distribution, mandatory coverage for critical paths, test naming, code review checklists, merge quality gates, performance benchmarks, and security guidelines — so that every change meets a consistent quality bar before reaching production.
