...
This specification defines the intelligent auto-scroll behavior for the chat interface, ensuring the viewport automatically follows streaming content while respecting user intent to view message history.
