...
This capability defines the practical, task-oriented guides for developers working on the project — quick start, local development environment, debugging, troubleshooting, common tasks, IDE configuration, and performance profiling — so that new and existing contributors can become productive quickly and resolve common issues independently.
