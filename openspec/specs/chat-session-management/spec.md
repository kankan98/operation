...
This capability provides API endpoints for managing individual messages within chat sessions, including deletion and regeneration of assistant responses.
