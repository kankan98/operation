# v0-trial-demo-data Specification

## Purpose
Define the local-only V0 trial demo-data path that gives internal evaluators one
safe, deterministic badminton live-commerce scenario across the implemented
trial workbenches, while preserving tenant/team scope, de-identification,
review provenance, and browser-verifiable guidance.
## Requirements
