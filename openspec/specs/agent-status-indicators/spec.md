...
This capability provides real-time visual feedback about the agent's processing state during response generation, including thinking, tool execution, and writing phases, with smooth transitions and tool-specific status indicators.
