...
This capability defines the team's development workflow standards — Git branching strategy, commit message conventions, feature development and bug-fixing workflows, the pull request process, the release process, and code review standards — so that collaboration is predictable, history stays clean, and changes flow to production safely.
