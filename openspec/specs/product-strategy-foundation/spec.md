# product-strategy-foundation Specification

## Purpose
Define the product direction, MVP scope, roadmap waves, Chinese operator workflow, and governed knowledge-plus-AI feedback loop for the badminton racket live-commerce operations workspace.
## Requirements
