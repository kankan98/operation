# ai-provider-port Specification

## Purpose
Define the server-only AI provider boundary for structured model generation,
DeepSeek adapter configuration, environment-variable secret handling, safe
