...
## Purpose
Define the frontend-only knowledge learning hub that makes the public source
registry, source review lifecycle, AI grounding loop, and operator feedback
signals visible before automated ingestion, persistence, or AI provider
integration exists.
