# knowledge-lifecycle-persistence Specification

## Purpose
Define the local-only persistence and server-only repository behavior for reviewed
knowledge sources, extracted claims, team notes, published versions and conflict
blockers. This capability is the audited grounding boundary before future AI
review, talk-track and Q&A workflows can use knowledge assets.
